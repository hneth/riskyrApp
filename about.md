...
An R Shiny application that complements the `riskyr` toolbox for transparent communication and teaching of risk literacy.
...
Retrieved from https://github.com/hneth/riskyr (R package version 0.0.0.911)
