                        ...
                        mainPanel(
                          ...
                          tabsetPanel(type = "tabs",
                                      ...
                                      tabPanel("Prism",
                                               br(),
                                               fluidRow(
                                                 column(8, offset = 2, plotOutput("prism", width = "750", height = "550"))),
                                               wellPanel(
                                                 fluidRow(
                                                   column(3, offset = 0,
                                      ...
                                      tabPanel("Table", 
                                               br(),
                                               fluidRow(
                                                 column(8, offset = 2, plotOutput("table", width = "650", height = "550"))),
                                               wellPanel(
                                                 fluidRow(
                                                   column(3, offset = 0,
                                      ...
                                      tabPanel("Area", 
                                               br(),
                                               fluidRow(
                                                 column(8, offset = 2, plotOutput("area", width = "650", height = "550"))),
                                               wellPanel(
                                                 fluidRow(
                                                   column(3, offset = 0,
                                      ...
                                      tabPanel("Bars", 
                                               br(),
                                               fluidRow(
                                                 column(8, offset = 2, plotOutput("bar", width = "650", height = "550"))),
                                               wellPanel(
                                                 fluidRow(
                                                   column(3, offset = 0,
